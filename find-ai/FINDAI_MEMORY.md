...
> **Last updated:** 2026-04-25 (v3.4.9 — **mobile keyboard numeric for digit-only fields**: IC last 4 + utility account # inputs now trigger number-pad on phones via `inputMode="numeric"` + `pattern="[0-9]*"` for iOS compatibility. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
