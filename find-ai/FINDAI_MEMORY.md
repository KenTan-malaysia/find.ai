...
> **Last updated:** 2026-04-25 (v3.4.8 — **WhatsApp forward button on score reveal**: green "Forward via WhatsApp" button now appears above Save Trust Card. Opens WhatsApp with pre-filled Trust Card summary including tenant name, IC tail, Trust Score, Behaviour × Confidence, LHDN status, utility coverage, avg payment timing, ref number. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
