...
> **Last updated:** 2026-04-25 (v3.4.5 — **IP + legal infrastructure**: 3-tier disclosure policy locked + public methodology doc + T&C / Privacy / Tenant Consent skeletons for lawyer + in-app `(?)` methodology panel + trade-secret server-side migration flagged for v1 · Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
