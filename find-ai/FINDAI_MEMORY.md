...
> **Last updated:** 2026-04-25 (v3.4.11 — **two cleanups**: removed redundant "Save Trust Card" PDF button (Trust Card preview + WhatsApp share already cover the artifact need), and made "all 3 utilities optional, at least 1 enough" CRYSTAL clear via updated Step 3 sub-text + new italic "Optional · pick easier method" tile placeholder. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
