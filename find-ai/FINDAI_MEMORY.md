...
> **Last updated:** 2026-04-25 (v3.4.10 — **score reveal "what next?" footer**: 2-button thumb-zone exit at end of score reveal — "🔄 Screen another tenant" (full state reset) + "← Done · Back to home" (closes modal, returns to landing). Solves Ken's UX gap "after scoring card, what's next?" Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
