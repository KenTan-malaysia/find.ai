...
> **Last updated:** 2026-04-25 (v3.4.7 — **Account # path now has deep-link verify step**: tap "Verify on TNB/Air Selangor/Maxis" → opens portal in new tab → return → "Mark verified" → done. Closes UX gap Ken caught: previously Account # tile jumped straight to Confirm without showing the deep-link pattern · Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
