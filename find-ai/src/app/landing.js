...
export default function Landing({ onStart, lang, setLang, hasSavedChat, onContinueChat }) {
  const t = {
    en: {
      badge: 'v1 · Built for Landlords',
      heroA: 'Malaysian',
      heroB: 'landlord law,',
      heroC: 'answered.',
      sub: 'Stuck on a tenant problem? Find.ai gives you the exact law, the exact steps, and the exact letter to send — in 10 seconds, for free.',
      cta: 'Start free →',
    ...
    bm: {
      badge: 'v1 · Untuk Tuan Rumah',
      heroA: 'Undang-undang',
      heroB: 'tuan rumah Malaysia,',
      heroC: 'dijawab.',
      sub: 'Ada masalah dengan penyewa? Find.ai beri anda undang-undang tepat, langkah tepat, dan surat tepat untuk dihantar — dalam 10 saat, percuma.',
      cta: 'Mula percuma →',
    ...
    zh: {
      ...
      heroB: '房东法律，',
      heroC: '即刻解答。',
      sub: '租客出问题？Find.ai 给你准确的法律条款、准确的步骤、准确的信件 — 10 秒内，免费。',
      cta: '免费开始 →',
      continueBtn: '继续上次对话',
      toggle: 'EN',
      free: '无需注册。免费试用。',
