...
>
> Estimated completion time for pilots: 10 minutes.
>
...
## Section 1 — About you (3 questions, required)

**Q1.1 — What's your role?** [Multiple choice, single answer]
- Landlord (1 unit)
- Landlord (2-5 units)
- Landlord (6-10 units)
- Landlord (10+ units)
...
**Q1.2 — Which state are you primarily based in?** [Multiple choice, single answer]
- KL / Selangor
- Penang
- Johor
- Sabah
...
**Q2.2 — Did the landing page motto "Don't sign blind" resonate with you?** [Multiple choice]
...
**Q2.3 — When you saw the three tile options (Screen / Audit / Stamp), which did you tap first?** [Multiple choice]
...
## Section 3 — The Screen tenant flow (8 questions, required)

**Q3.1 — Overall, how easy was the flow to follow?** [Linear scale 1-5: Very confusing → Very easy]

**Q3.2 — Did you understand what the LHDN cert verification step was for?** [Multiple choice]
- Yes — clear
- Somewhat
- No — what's an LHDN cert?
- Skipped that step entirely

**Q3.3 — Did you tap the "Skip — no cert / first-time renter" option?** [Multiple choice]
...
**Q3.4 — On the utility bills step, which method did you use?** [Multiple choice, can pick multiple]
- Account number
- Upload bill (PDF / photo)
- Tried both
- Skipped

**Q3.5 — Did you understand the difference between the two methods?** [Multiple choice]
- Yes — the labels were clear
- Mostly — but had to think about it
- No — I just picked one
- Didn't notice both options

**Q3.6 — Did you understand the Trust Score formula (Behaviour × Confidence)?** [Multiple choice]
- Yes — clear concept
- Somewhat — got the gist
- No — felt like a black box
- Didn't see / read it

**Q3.7 — Did you tap the "How is this calculated?" link?** [Yes / No]

**Q3.7a — If yes, was the explanation helpful?** [Linear scale 1-5: Not at all → Very]

**Q3.8 — How does the Trust Card visual look to you?** [Multiple choice, can pick multiple]
...
**Q4.2 — What ONE thing would make you definitely use it?** [Open text]
...
## Section 6 — Comparison with current methods (3 questions, optional)

**Q6.1 — How do you currently screen tenants?** [Multiple choice, can pick multiple]
...
## Section 8 — Stay in touch (1 question, optional)

**Q8.1 — Email (optional, only if you want updates + free first 5 real screenings when v1 launches):** [Short answer — email validation]

> *We'll only email you about the v1 launch and your free screening credits. We won't add you to a marketing list.*
...
Your feedback shapes the v1 launch. I'll send a "what shipped because of pilot feedback" summary to all participants in 4 weeks.
...
- **Show progress bar:** YES — sets pilot expectations
- **Confirmation message:** Use the "Form ending message" above
- **Response destination:** Link to a Google Sheets tab so all responses aggregate cleanly

---

## How to analyze responses

After 7+ pilots have completed the form:
...
- v1.0 — 2026-04-25 — Initial form structure (v3.4.6). Tested for ~10 min pilot completion time.
